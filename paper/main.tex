...
\begin{table}[hbtp]
\centering
\caption{Regex vs. Comby for C++ (top), Java (middle), and Rust (bottom)}
...
\begin{tabularx}{\columnwidth}{Xllrrr}
 ...
 \multirow{4}{*}{\textbf{Overall}} & \multirow{2}{*}{\bf Regex} & Mean     & 890.67 &  1553.83 & 35.28\% \\
%                          & & Med.    & 671.00 & 1579.00  & 23.88\%   \\
                          & & Std.Dev. & 787.62 & 956.31   & 19.48\%  \\\cline{2-6}
  & \multirow{2}{*}{\bf Comby}  & Mean     & 837.83 & 1352.50 & 38.75\%  \\
...
\mc{6}{c}{\textbf{Java}} \\\midrule
                 &              & \multicolumn{2}{c|}{\textbf{Regex}} &\multicolumn{2}{c}{\textbf{Comby}}  \\
\textbf{Project} & \textbf{LOC} & \textbf{Mutants} & \textbf{\% Valid} & \textbf{Mutants} &  \textbf{\% Valid} \\\midrule
 pebble         & 279 & 1014 & 8.48\%  & 752 & 11.30\%  \\[1ex]
 spring-hateoas & 397 & 2479 & 10.00\% & 1384 & 12.43\%  \\[1ex]
 javacc         & 363 & 1888 & 28.70\% & 1281 & 38.71\%  \\[1ex]
 coffee-gb      & 463 & 1927 & 11.63\% & 798 & 21.80\% \\[1ex]
 egads          & 252 & 2427 & 25.43\% & 1163 & 51.33\%  \\[1ex]
 apk-parser     & 324 & 1583 & 22.17\% & 1199 & 27.77\%  \\[1ex]\bottomrule
\end{tabularx}
\begin{tabularx}{\columnwidth}{Xllrrr}
...
strum            & 90           & $\frac{51}{428}$     & 11.92\%  & $\frac{50}{368}$     & 13.58\% \\[1ex]\bottomrule
\end{tabularx}
\begin{tabularx}{\columnwidth}{Xllrrr}
               & & & Valid  & Invalid  & \% \\\midrule
