...
\cite{mucheck}.  Furthermore, that tool may no longer  be
supported (the last commits or package updates were in 2015), and it
is not clear that a successor tool has appeared in the ensuing years.
...
In addition to these core research questions, evaluated over six files
from six real-world projects for four languages, we also present a
case study, applying our implementation to a program in a language for
which it has no rules, Haskell.
...
\multirow{2}{*}{ompl} & \multicolumn{2}{c|}{Regex} & 595 & 1938 & 23.49\%  \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 564 & 1610 & 25.94\% \\ \hline
\multirow{2}{*}{libgraphqlparser} & \multicolumn{2}{c|}{Regex} & 157 & 584 & 21.19\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 131 & 309 & 29.77\% \\ \hline
\multirow{2}{*}{rethinkdb\_rebirth} & \multicolumn{2}{c|}{Regex} & 545 & 1701 & 24.27\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 492 & 1517 & 24.49\% \\ \hline
...
\hline
 & \multicolumn{2}{c|}{} & \textbf{Valid} & \textbf{Invalid} & \textbf{Valid \%}  \\ \hline
\multirow{2}{*}{pebble} & \multicolumn{2}{c|}{Regex} & 86 & 928 & 8.48\%  \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 85 & 667 & 11.30\% \\ \hline
\multirow{2}{*}{spring-hateoas} & \multicolumn{2}{c|}{Regex} & 248 & 2231 & 10.00\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 172 & 1212 & 12.43\% \\ \hline
\multirow{2}{*}{javacc} & \multicolumn{2}{c|}{Regex} & 542 & 1346 & 28.70\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 494 & 782 & 38.71\% \\ \hline
...
\multirow{2}{*}{keract} & \multicolumn{2}{c|}{Regex} & 1655 & 1600 &	729 & 41.53\%  \\\cline{2-7}
    & \multicolumn{2}{c|}{Comby} & 1471 & 1063 & 533 & 47.96\% \\ \hline
\multirow{2}{*}{dtw} & \multicolumn{2}{c|}{Regex} & 973 & 566 & 567 & 46.20\% \\\cline{2-7}
    & \multicolumn{2}{c|}{Comby} & 866 & 330 & 639 &	47.19\% \\ \hline
\multirow{2}{*}{notion-sdk-py} & \multicolumn{2}{c|}{Regex} & 196 & 760 & 82 & 18.89\% \\\cline{2-7}
    & \multicolumn{2}{c|}{Comby} & 196 & 701 & 122 & 19.23\% \\ \hline
    
\multirow{2}{*}{{\makecell{atlassian-python \\ api}}} & \multicolumn{2}{c|}{Regex} & 302	& 1002 & 207 &	19.99\% \\\cline{2-7}
    & \multicolumn{2}{c|}{Comby} & 333 & 635 & 351 & 25.25\% \\ \hline
\multirow{2}{*}{ESD} & \multicolumn{2}{c|}{Regex} & 1859	& 2767 & 1642 & 29.46\% \\\cline{2-7}
    & \multicolumn{2}{c|}{Comby} & 1712 & 1548 &	614 & 44.18\% \\ \hline
\multirow{2}{*}{fiber} & \multicolumn{2}{c|}{Regex} & 493 & 909 & 163 & 31.08\% \\\cline{2-7}
    & \multicolumn{2}{c|}{Comby} & 458 & 767	& 241 & 31.24\% \\ \hline
...
\hline
 & \multicolumn{2}{c|}{} & \textbf{Valid} & \textbf{Invalid} & \textbf{Valid \%}  \\ \hline
\multirow{2}{*}{cargo release} & \multicolumn{2}{c|}{Regex} & 851 &	1163 & 42.25\%  \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 1690 & 711 & 70.39\% \\ \hline
\multirow{2}{*}{passerine} & \multicolumn{2}{c|}{Regex} & 213 & 2081 & 9.29\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 173 & 1518 & 10.23\% \\ \hline
\multirow{2}{*}{typos} & \multicolumn{2}{c|}{Regex} & 386 & 1534 & 20.10\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 366 & 1199 &	 23.39\% \\ \hline
...
invalid mutants (13.33\% validity).  These mutants produce a mutation
