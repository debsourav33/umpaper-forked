...
\multirow{2}{*}{spring-hateoas} & \multicolumn{2}{c|}{Regex} & 248 & 2231 & 10.00\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 176 & 1212 & 12.68\% \\ \hline
\multirow{2}{*}{javacc} & \multicolumn{2}{c|}{Regex} & 542 & 1346 & 28.70\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 503 & 782 & 39.14\% \\ \hline
...
\multirow{2}{*}{egads} & \multicolumn{2}{c|}{Regex} & 624 & 1830 & 25.43\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 622 & 566 & 52.36\% \\ \hline
\multirow{2}{*}{apk-parser} & \multicolumn{2}{c|}{Regex} & 351 & 1232 & 22.17\% \\\cline{2-6}
    & \multicolumn{2}{c|}{Comby} & 338 & 866 & 28.07\% \\ \hline
...
\multirow{6}{*}{Overall} & \multirow{3}{*}{Regex} & Mean & 345.83 & 1545.00  & 17.74\%\\\cline{3-6}
 ...
 & \multirow{3}{*}{Comby} & Mean & 316.33 & 786.17 & 27.56\% \\\cline{3-6}
    &   &  Median & 257.00 & 724.50 & 24.94\%  \\\cline{3-6}
    &   &  Std. Dev & 210.81 & 235.24  & 15.93\%  \\\hline
