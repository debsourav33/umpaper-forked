...
\begin{tabularx}{\columnwidth}{Xllrrr}
 ...
 & \mr{2}{Comby} & Mean     & 554.00 &  1055.83 & 29.29\% \\
 %              &   & Med.     & 253.50 & 724.50 & 24.79\% \\
...
\caption{Regex vs. Comby for Python.   LOC describes the project files considered. Muts. is total number of mutants generated for those files. \claire{FIXME: what's an invalid mutant for python?}  We can use TCE to check for redundant Python mutants, shown under ``Red.''}
...
\begin{table}[htbp]
\centering
\caption{Java (Our Implementation vs. PIT vs. LittleDarwin). \claire{FIXME: explain why no eqv for PIT.} LittleDarwin produces no equivalent mutants.\claire{right?}}
...
spring- & \mr{2}{176} & \mr{2}{0.37} & \mr{2}{0\%} & \mr{2}{114} & \mr{2}{0.28}  & \mr{2}{38} & \mr{2}{0.39}  \\
hateoas  &    &       &     &    &   &   &   \\[0.5ex]
javacc & 503 & 0.21 & 0\% & 143 & 0.21  & 82 & 0.78  \\
coffee-gb & 174 & 0.23 & 0\% & 36 & 0.89 & 29 & 0.38  \\
egads & 622 & 0.71 & 10\% & 107 & 0.81  & 85 & 0.87  \\
apk-parser & 338 & 0.08 & 0\% & 89 & 0.16  & 33 & 0.09 \\
\midrule
\textbf{Mean} &  316.33 & 0.40 & 5.00\% & 84.83 & 0.55  & 45.83 & 0.59  \\
\textbf{Std.Dev.} &  210.81 & 0.29 & 8.37\% & 47.60 & 0.37 & 30.93 & 0.35 \\\bottomrule
\end{tabular}
}
\end{table}
...
Fiber & 458 & 0.64 & 20\% & 222 & 0.57 & 40\% & 320 & 0.81 & 0\% \\
\textbf{Mean} &  839.33 & 0.46 & 18.00\% & 321.83 & 0.53 & 10.00\% & 520.93 & 0.46 & 8.33\% \\
\textbf{Std.Dev.} &  628.80 & 0.24 & 11.69\% & 239.04 & 0.24 & 15.49\% & 417.50 & 0.28 & 7.53\%
...
strum & 50 & 0.22 & 40\% & 2 & 1.00 & 0\%   \\
\textbf{Mean}   & 554.00 & 0.64 & 22.00\% & 3.17 & 0.54 & 0.00\%\\
